...
(function () {
  ...
  const products = [
    {
      id: 'p1',
      name: 'Rose Gold Stunner',
      desc: 'Hot pink + rose gold glitter on a 30oz quencher. Shimmer like the queen you are.',
      price: 40,
      emoji: '🌹',
      badge: 'Best Seller',
      category: 'glitter',
    },
    {
      ...
      desc: 'Deep navy with holographic galaxy glitter. Stars in every sip.',
      price: 40,
      emoji: '🌌',
      badge: 'Fan Fave',
      category: 'glitter',
    },
    {
      ...
      desc: 'Personalized 20oz skinny with your name in gold script. The perfect gift.',
      price: 40,
      emoji: '✍️',
      badge: 'Custom',
      category: 'custom',
    ...
    {
      id: 'p4',
      name: 'Teal Queen Mermaid',
      desc: 'Teal + opal chameleon flakes with mermaid crown vinyl. Mythical vibes only.',
      price: 40,
      emoji: '🧜',
      badge: 'Limited',
      category: 'glitter',
    ...
    {
      id: 'p5',
      name: 'Fall Harvest Vibes',
      desc: '40oz mega in warm burnt orange with gold chunky glitter. Autumn queen energy.',
      price: 40,
      emoji: '🍂',
      badge: 'Seasonal',
      category: 'seasonal',
    ...
    {
      id: 'p6',
      name: 'Bride Squad Set',
      desc: 'Set of 4 matching 20oz skinnies. Mix colors for the whole squad. Starts at $152.',
      price: 38,
      origPrice: 40,
      emoji: '👰',
      badge: 'Set Deal',
    ...
    {
      id: 'p7',
      name: 'Chrome Mirror Black',
      desc: 'Jet black with chrome mirror finish on a 30oz. Sleek, bold, unbothered.',
      price: 40,
      emoji: '🖤',
      badge: null,
      category: 'glitter',
    ...
    {
      id: 'p8',
      name: 'Glow-in-Dark Queen',
      desc: 'Hot pink by day, glowing magenta by night. 20oz skinny. Glow-up guaranteed.',
      price: 40,
      emoji: '🌙',
      badge: 'New Arrival',
      category: 'custom',
